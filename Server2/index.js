                ...
                switch (req.method) {
                    ...
                    case 'POST':
                        ...
                        try {
                            ...
                            database.query('CREATE TABLE public.people (id int8 GENERATED BY DEFAULT AS IDENTITY(INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,created_at timestamptz DEFAULT now() NOT NULL,"name" text NULL,dob date NULL,CONSTRAINT people_pkey PRIMARY KEY(id));');
                        }
